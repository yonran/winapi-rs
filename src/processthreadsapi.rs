...
// make it easier to construct: let mut startupinfo: STARTUPINFOW = ::std::default::Default::default();
impl ::std::default::Default for STARTUPINFOW {
    fn default() -> STARTUPINFOW {
        STARTUPINFOW {cb:0, lpReserved: ::std::ptr::null_mut(), lpDesktop: ::std::ptr::null_mut(), lpTitle: ::std::ptr::null_mut(), dwX:0, dwY:0, dwXSize:0, dwYSize:0, dwXCountChars:0, dwYCountChars:0, dwFillAttribute:0, dwFlags: 0, wShowWindow:0, cbReserved2:0, lpReserved2: ::std::ptr::null_mut(), hStdInput: ::std::ptr::null_mut(), hStdOutput: ::std::ptr::null_mut(), hStdError: ::std::ptr::null_mut(),}
    }
}
